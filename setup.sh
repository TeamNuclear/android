...
sleep 3
clear
echo Where do you want to initialize NR source? Enter the desired directory name similar to this:
echo " /home/$USER/nr or /media/$USER/yourdrive/nr"
read rrpath
clear
sleep 2
echo Creating and Initializing NR Source at $rrpath in 5...
sleep 1
echo Creating and Initializing NR Source at $rrpath in 4...
sleep 1
echo Creating and Initializing NR Source at $rrpath in 3...
sleep 1
echo Creating and Initializing NR Source at $rrpath in 2...
sleep 1
echo Creating and Initializing NR Source at $rrpath in 1...
sleep 1
mkdir -p $rrpath
cd $rrpath
repo init -u https://github.com/TeamNuclear/android.git -b cm12.1
clear
echo NR Source Code has been initialized!
sleep 4
clear
...
sleep 3
        ...
        repo sync -j $jobs
        clear
                echo Unpacking all NucleaRom Resources in 5 seconds...
                sleep 1
                echo Unpacking all NucleaRom Resources in 4 seconds...
                sleep 1
                echo Unpacking all NucleaRom Resources in 3 seconds...
                sleep 1
                echo Unpacking all NucleaRom Resources in 2 seconds...
                sleep 1
                echo Unpacking all NucleaRom Resources in 1 seconds...
                sleep 1
        clear
        ...
        sleep 3
        clear
                echo NucleaRom Source code has been Set-Up Succesfully in
                echo $rrpath
sleep 3
echo  
                echo To build NucleaRom later, initialize the NR Build Wizard by typing:
                echo "./build-nr.sh"
                echo in $rrpath
sleep 3
                echo Starting the NucleaRom Build Wizard in 10 seconds!
